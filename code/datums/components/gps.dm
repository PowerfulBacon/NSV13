...
/datum/component/gps/item/ui_data(mob/user)
	...
	data["currentCoords"] = "[curr.x], [curr.y], [curr.get_z_level(TRUE)]"
	...
	for(var/gps in GLOB.GPS_list)
		...
		if(!pos || !global_mode && pos.get_z_level(TRUE) != curr.get_z_level(TRUE))
			continue
		var/list/signal = list()
		signal["entrytag"] = G.gpstag //Name or 'tag' of the GPS
		signal["coords"] = "[pos.x], [pos.y], [pos.get_z_level(TRUE)]"
		if(pos.get_z_level(TRUE) == curr.get_z_level(TRUE)) //Distance/Direction calculations for same z-level only
