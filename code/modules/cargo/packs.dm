...
/* /datum/supply_pack/security/laser //NSV13 - See nsv13/code/modules/cargo/packs.dm for new one
	name = "Lasers Crate"
...
/* /datum/supply_pack/security/armory/energy_single //NSV13 - not available
