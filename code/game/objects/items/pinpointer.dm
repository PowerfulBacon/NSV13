...
/obj/item/pinpointer/update_icon()
	...
	if(here.get_z_level(TRUE) != there.get_z_level(TRUE))
		if(here.get_z_level(TRUE) > there.get_z_level(TRUE))
...
/obj/item/pinpointer/crew/proc/trackable(mob/living/carbon/human/H)
	var/turf/here = get_turf(src)
	if((H.z == 0 || H.get_z_level(TRUE) == here.get_z_level(TRUE) || (is_station_level(here.z) && is_station_level(H.z))) && istype(H.w_uniform, /obj/item/clothing/under))
		...
		return (H.z != 0 || (there && ((there.get_z_level(TRUE) == here.get_z_level(TRUE)) || (is_station_level(there.z) && is_station_level(here.z)))))
