...
/obj/machinery/telecomms/receiver/proc/check_receive_level(datum/signal/subspace/signal)
	...
	for(var/obj/machinery/telecomms/hub/H in links)
		for(var/obj/machinery/telecomms/relay/R in H.links)
			if(R.can_receive(signal) && (R.get_z_level(TRUE) in signal.levels))
				return TRUE
...
/obj/machinery/telecomms/receiver/preset_right
	...
	freq_listening = list(FREQ_COMMAND, FREQ_ENGINEERING, FREQ_SECURITY, FREQ_MUNITIONS) //NSV13 - Munitions added
